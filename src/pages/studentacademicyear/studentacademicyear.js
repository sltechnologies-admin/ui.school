          ...
          <Modal.Body className="modalBodyScrollable">
            <Form id="filterForm" onSubmit={handleFilterSubmit}>
              <Form.Group controlId="academic_year_name" className="commonInput">
                ...
                <Form.Control
                  ...
                  onChange={(e) =>
                    setFilter({
                      ...filter,
                      academic_year_name: e.target.value
                        .replace(/[^0-9\s-]/g, '')
                        .replace(/\s{2,}/g, ' ')
                        .substring(0, 30)
                        .trim(),
              ...
              <Form.Group controlId="start_month" className="commonInput">
                ...
                <Form.Select
                  name="start_month"
                  value={filter.start_month}
                  onChange={(e) => setFilter({ ...filter, start_month: parseInt(e.target.value || '0', 10) })}
                >
              ...
              <Form.Group controlId="start_year" className="commonInput">
                ...
                <Form.Select
                  ...
                  onChange={(e) => setFilter({ ...filter, start_year: parseInt(e.target.value || '0', 10) })}
                >
              ...
              <Form.Group controlId="end_month" className="commonInput">
                ...
                <Form.Select
                  name="end_month"
                  value={filter.end_month}
                  onChange={(e) => setFilter({ ...filter, end_month: parseInt(e.target.value || '0', 10) })}
                >
              ...
              <Form.Group controlId="end_year" className="commonInput">
                ...
                <Form.Select
                  ...
                  onChange={(e) => setFilter({ ...filter, end_year: parseInt(e.target.value || '0', 10) })}
                >
              ...
              <Form.Group controlId="is_current_year" className="commonInput">
                ...
                <Form.Select
                  ...
                  value={filter.is_current_year}
                  onChange={(e) => setFilter({ ...filter, is_current_year: e.target.value })}
                >
