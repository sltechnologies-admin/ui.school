...
const AddFeeitems = () => {
    ...
    const [feeitems, setFeeitems] = useState(null);
    ...
    const fetchfeeitemlist = async () => {
        try {
            const response = await axios.post(baseUrl + "/Feeitemslist/", { action: "DROPDOWNREAD", school_id: userObj.school_id });
                            ...
                            <Card>
                                <Card.Body>
                                    <form onSubmit={handleSubmit}>
                                        <Row>
                                            <Col xs={12}>
                                                <h6 className='commonSectionTitle'>Fees Items Amount  Details</h6>
                                            </Col>
                                        </Row>
                                        <Row>
                                                    ...
                                                    <Form.Group>
                                                        ...
                                                        >
                                                            ...
                                                            {(feeitemlists || []).map((feeitemlist) => (
                                                                <option key={feeitemlist.fees_item_id} value={feeitemlist.fees_item_id}>
                                            ...
                                            <Col xs={12} md={6} lg={4} xxl={4}>
                                                <div className='commonInput'>
                                                    <Form.Group>
                                                        <Form.Label>Fees Item Amount <span className='requiredStar'>*</span></Form.Label>
                                                        <Form.Control
                                                            required
                                                            type="text"
                                                            id="fees_item_amount"
                                                            ...
                                                            onChange={(e) => {
                                                                ...
                                                                if (!isNaN(value)) {
                                                                    handleInputChange(e); // Only update if value is a valid number
                                                                }
                                                            }}
                                                        />
                                                    </Form.Group>
