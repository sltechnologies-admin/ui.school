...
const Sections = () => {
    ...
    const handleEditClick = (section_id) => {
        ...
        if (sectionmasterToEdit) {
            navigate("/AddNewSections", { state: { sectionData: sectionmasterToEdit } });
        } else {
                ...
                <div className="pageBody">
                    <div className="commonDataTableHead">
                        <div className="d-flex justify-content-between align-items-center w-100">
                            ...
                            <div className="">
                                <input type="text" placeholder="Search..."   value={searchQuery} maxLength={30}  className="searchInput"  onChange={handleSearchChange} />
                            </div>
                            <div className="d-flex align-items-center" style={{ gap: 6 }}>
                                ...
                                <OverlayTrigger placement="top" overlay={<Tooltip id="tooltip-top">Add</Tooltip>}>
                                    <Button className="primaryBtn" variant="primary" onClick={() => navigate("/AddNewSections")}>
                                        <MdAddCircle />
                                    </Button>
                                </OverlayTrigger>
                            </div>
                    ...
                    <div className="commonTable height100">
                        <div className="tableBody">
                            {isLoading ? (
                                ...
                                <DataTable
                                    className="custom-table" columns={columns}
                                    ...
                                    conditionalRowStyles={[
                                        {
                                            ...
                                            style: { textAlign: "center",fontSize: "16px",backgroundColor: "#f9f9f9" },
                                        },
                                    ]}
                                />
                            )}
                            ...
                            <Col xs={12}>
                                <div className='commonInput'>
                                    <Form.Group controlId="academic_year_id">
                                        ...
                                        <Form.Select id="academic_year_id"  name="academic_year_id" value={filter.academic_year_id}
                            ...
                            <Col xs={12}>
                                <div className='commonInput'>
                                    <Form.Group controlId="Class_name">
                                        ...
                                        <Form.Select  id="class_id"    name="class_id" value={filter.class_id} onChange={(e) => setFilter({ ...filter, class_id: e.target.value })}>
                                            <option value="">Select Class</option>
                                            {(classes || []).map((depti) => (
                                                <option key={depti.class_id} value={depti.class_id}>{depti.class_name}</option>
                                            ))}
                                        </Form.Select>
                                    </Form.Group>
                                </div>
                            ...
                            <Col xs={12}>
                                <div className='commonInput'>
                                    <Form.Group controlId="Department">
                                        ...
                                        <Form.Control type="text" id="section_name" name="section_name" value={filter.section_name} maxLength={30} placeholder="Enter Section"
                                            onChange={(e) => {
                            ...
                            <Col xs={12}>
                                <div className='commonInput'>
                                    <Form.Group controlId="City">
                                        ...
                                        <Form.Control type="text"  id="room_number" placeholder="Enter Room Number" value={filter.room_number} maxLength={30}
                                            onChange={(e) => {
